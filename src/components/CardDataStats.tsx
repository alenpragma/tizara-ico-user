...
const CardDataStats: React.FC<CardDataStatsProps> = ({
  ...
  return (
    <div className="rounded-md cursor-pointer border border-stroke bg-white  py-6 px-3 lg:py-10 lg:px-4.5 shadow-default dark:border-strokedark dark:bg-boxdark">

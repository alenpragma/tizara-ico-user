...
type PasswordField = 'newPass' | 'confirmPass';
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        ...
                        <span
                          ...
                          className="absolute text-black dark:text-white right-4 top-4"
                        >
                    ...
                    <div className="mb-6">
                      ...
                      <div className="relative">
                        <input
                          ...
                          type={
                            passwordVisible.confirmPass ? 'text' : 'password'
                          }
                        ...
                        <span
                          onClick={() =>
                            togglePasswordVisibility('confirmPass')
                          }
                          className="absolute text-black dark:text-white right-4 top-4"
                        >
